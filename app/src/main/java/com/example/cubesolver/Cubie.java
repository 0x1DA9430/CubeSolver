...
class Cubie {
     ...
     */
    static Cubie[] CubeSym = new Cubie[16];
     ...
     */
    static char[] FlipS2R = new char[Coordinate.N_FLIP_SYM];
    static char[] TwistS2R = new char[Coordinate.N_TWIST_SYM];
    static char[] EPermS2R = new char[Coordinate.N_PERM_SYM];
    static byte[] Perm2CombP = new byte[Coordinate.N_PERM_SYM];
    static char[] PermInvEdgeSym = new char[Coordinate.N_PERM_SYM];
    static byte[] MPermInv = new byte[Coordinate.N_MPERM];
     ...
     */
    static char[] FlipR2S = new char[Coordinate.N_FLIP];
    static char[] TwistR2S = new char[Coordinate.N_TWIST];
    static char[] EPermR2S = new char[Coordinate.N_PERM];
    static char[] FlipS2RF = Solver.USE_TWIST_FLIP_PRUN ? new char[Coordinate.N_FLIP_SYM * 8] : null;

    /**
     *
     */
    static char[] SymStateTwist;// = new char[Coordinate.N_TWIST_SYM];
    static char[] SymStateFlip;// = new char[Coordinate.N_FLIP_SYM];
    static char[] SymStatePerm;// = new char[Coordinate.N_PERM_SYM];
    ...
    static void CornConjugate(Cubie a, int idx, Cubie b) {
        Cubie sinv = CubeSym[SymMultInv[0][idx]];
        Cubie s = CubeSym[idx];
        for (int corn = 0; corn < 8; corn++) {
    ...
    static void initFlipSym2Raw() {
        initSym2Raw(Coordinate.N_FLIP, FlipS2R, FlipR2S,
                SymStateFlip = new char[Coordinate.N_FLIP_SYM], 0);
    }

    static void initTwistSym2Raw() {
        initSym2Raw(Coordinate.N_TWIST, TwistS2R, TwistR2S,
                SymStateTwist = new char[Coordinate.N_TWIST_SYM], 1);
    }

    static void initPermSym2Raw() {
        initSym2Raw(Coordinate.N_PERM, EPermS2R, EPermR2S,
                SymStatePerm = new char[Coordinate.N_PERM_SYM], 2);
        Cubie cc = new Cubie();
        for (int i = 0; i < Coordinate.N_PERM_SYM; i++) {
        ...
        for (int i = 0; i < Coordinate.N_MPERM; i++) {
            cc.setMPerm(i);
            cc.invCubieCube();
